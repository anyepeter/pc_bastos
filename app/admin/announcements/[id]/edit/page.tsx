...
import { getAnnouncementById, createAnnouncement, updateAnnouncement } from '@/app/actions/announcements';
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900">
            Edit {announcementConfig.singular.toLowerCase()}
          </h1>
      ...
      <ResourceForm
        ...
        initialValues={toFormValues(announcementConfig, row)}
