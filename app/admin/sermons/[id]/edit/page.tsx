...
import { getSermonById, createSermon, updateSermon } from '@/app/actions/sermons';
...
export default async function EditSermonPage({
  ...
  const result = await getSermonById(params.id);
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900">
            Edit {sermonConfig.singular.toLowerCase()}
          </h1>
      ...
      <ResourceForm
        ...
        initialValues={toFormValues(sermonConfig, row)}
